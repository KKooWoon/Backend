...
public class CommentController {
    ...
    public ResponseEntity<CommentCreateResultDto> createComment(
        ...
        return new ResponseEntity<>(commentService.createComment(accountId, confirmId, commentCreateDto), HttpStatus.OK);
    }
    ...
    public ResponseEntity<CommentUpdateResultDto> updateComment(
        ...
        return new ResponseEntity<>(commentService.updateComment(accountId, commentId, commentUpdateDto), HttpStatus.OK);
    }
