...
public class RaceController {
    ...
    public ResponseEntity<RaceCreateResultDto> createRace(
            @ApiParam(value = "레이스 주인 닉네임", required = true, example = "꾸운닉123")
        ...
        return new ResponseEntity<>(raceService.createRace(ownerNickname, raceCreateDto), HttpStatus.OK);
    }
    ...
    public ResponseEntity<RaceParticipateResultDto> participateRace(
        ...
        return new ResponseEntity<>(raceService.participateRace(nickname, raceCode, racePassword), HttpStatus.OK);
    }
    ...
    public ResponseEntity<RaceLeaveResultDto> leaveRace(
            ...
            @ApiParam(value = "레이스 코드", required = true, example = "AHDJIK")
            @RequestParam String raceCode) {
        return new ResponseEntity<>(raceService.leaveRace(nickname, raceCode), HttpStatus.OK);
    }
    ...
    public ResponseEntity<RaceDeleteResultDto> deleteRace(
            @ApiParam(value = "레이스 방장 닉네임", required = true, example = "꾸운닉123")
            @RequestParam String ownerNickname,
            @ApiParam(value = "레이스 코드", required = true, example = "AHDJIK")
            @RequestBody String raceCode,
            @ApiParam(value = "레이스 비밀번호", required = true, example = "kkoowoon123!")
            @RequestBody String racePassword) {
        return new ResponseEntity<>(raceService.deleteRace(ownerNickname, raceCode, racePassword), HttpStatus.OK);
    }
    ...
    public ResponseEntity<CurrentRaceListDto> getCurrentRaceList(
            @ApiParam(value = "레이스 참여자 닉네임", required = true, example = "꾸운닉123")
            @RequestParam String nickname) {
        return new ResponseEntity<>(raceService.findCurrentRaceList(nickname), HttpStatus.OK);
    }
    ...
    public ResponseEntity<PastRaceListDto> getPastRaceList(
            @ApiParam(value = "레이스 참여자 닉네임", required = true, example = "꾸운닉123")
            @RequestParam String nickname) {
        return new ResponseEntity<>(raceService.findPastRaceList(nickname), HttpStatus.OK);
    }
    ...
    public ResponseEntity<AllRaceListDto> getAllRaceList(
            @ApiParam(value = "레이스 참여자 닉네임", required = true, example = "꾸운닉123")
            @RequestParam String nickname) {
        return new ResponseEntity<>(raceService.findAllRaceList(nickname), HttpStatus.OK);
    }
