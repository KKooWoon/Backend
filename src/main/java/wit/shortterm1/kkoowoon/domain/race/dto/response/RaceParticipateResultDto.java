...
public class RaceParticipateResultDto {
    ...
    public RaceParticipateResultDto(boolean isSuccess, String ownerNickname, Long raceId, LocalDateTime participatedAt) {
    ...
    public static RaceParticipateResultDto createDto(boolean isSuccess, String ownerNickname, Long raceId, LocalDateTime participatedAt) {
        return new RaceParticipateResultDto(isSuccess, ownerNickname, raceId, participatedAt);
    }
}
