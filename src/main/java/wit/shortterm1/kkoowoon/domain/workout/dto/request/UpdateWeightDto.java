...
public class UpdateWeightDto {
    ...
    private UpdateWeightDto(String name, String body, List<WeightSetDto> weightSetList) {
        this.name = name;
        this.body = body;
        this.weightSetList = weightSetList;
    }

    public static UpdateWeightDto createDto(String name, String body, List<WeightSetDto> weightSetList) {
        return new UpdateWeightDto(name, body, weightSetList);
    }
}
