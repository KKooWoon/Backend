...
public class WeightCreateResultDto {
    ...
    public WeightCreateResultDto(boolean isSuccess, Long weightId,
                                 LocalDateTime createdAt, LocalDate date) {
    ...
    public static WeightCreateResultDto createDto(boolean isSuccess, Weight weight, LocalDate date) {
        return new WeightCreateResultDto(isSuccess, weight.getId(), weight.getCreatedAt(), date);
    }
}
